...
\usepackage{capt-of}
\usepackage{hyperref}
\date{\textit{{[}2026-07-07 Tue 23:09]}}
\title{emacs config chemac2}
\hypersetup{
 pdfauthor={},
 pdftitle={emacs config chemac2},
 pdfkeywords={},
 pdfsubject={},
...
\section{lets try to see if its works.}
\label{sec:org595e3bd}
\subsection{now package is all set in the init.el so no need to load them here again}
\label{sec:org830dcd5}
skipped
\subsection{Make sure to download packages if not present}
\label{sec:orgc8c68ee}
\begin{verbatim}
(require 'use-package)
...
(menu-bar-mode -1)
\end{verbatim}
\section{to be checked later.}
\label{sec:orgb12dc84}
(setq package-enable-at-startup nil)

;; (load-theme 'dichromacy t)
\section{Fonts}
\label{sec:orgfb22af5}
\begin{verbatim}
...
\end{verbatim}
\subsection{test}
\label{sec:org68e4120}
\subsubsection{}
\label{sec:org23db4de}
\section{themes}
\label{sec:org0f86ba6}
\begin{verbatim}
...
\end{verbatim}
\section{WHICH KEY shows next possible keys}
\label{sec:orgc97cec6}
\begin{verbatim}
...
\end{verbatim}
\section{org todos}
\label{sec:org7424749}
\begin{verbatim}
(setq org-todo-keywords

      '((sequence "TODO" "|" "DONE" )))
\end{verbatim}
\section{vertico and marginmarginalia — how minibuffer completions look}
\label{sec:org92c891b}
\begin{verbatim}
(use-package vertico
...
\end{verbatim}
\section{startbuffer and upcase downcase}
\label{sec:org14d08a7}
\begin{verbatim}
...
\label{sec:orgcec8179}
\begin{verbatim}
(use-package all-the-icons)
\end{verbatim}
\section{moody modeline}
\label{sec:org1604708}
\begin{verbatim}
(use-package moody
   :config
...
\end{verbatim}
\section{Beacon}
\label{sec:org50be406}
\begin{verbatim}
(use-package beacon)
(beacon-mode 1)
\end{verbatim}
\section{company}
\label{sec:org0fa2a8c}
\begin{verbatim}
...
\end{verbatim}
\subsection{denote explore package}
\label{sec:orgc933c22}
\begin{verbatim}
...
\end{verbatim}
\section{dired specific keybinds}
\label{sec:org2da994a}
\begin{verbatim}
...
\end{verbatim}
\section{Better Completions}
\label{sec:org05f46fe}
\begin{verbatim}
(use-package ivy
  :defer t
  :diminish
...
(setq org-priority-names '((?A . "High")
                          ...
                          (?D . "Optional")))
\end{verbatim}
\subsection{org latex output engine to tectonic}
\label{sec:org369ab6d}
\begin{verbatim}
(setq org-latex-pdf-process 
    '("tectonic -X compile --outdir=%o -Z shell-escape -Z continue-on-errors %f"))
\end{verbatim}
\section{elfeed}
\label{sec:org32698bb}
\begin{verbatim}
(use-package elfeed
     :config
...
\end{verbatim}
\section{display line number}
\label{sec:orgaadebc1}
\begin{verbatim}
(global-display-line-numbers-mode 1)
(setq display-line-numbers-type 'relative)
\end{verbatim}
\section{golden ratio}
\label{sec:org5e5c42d}
\begin{verbatim}
(use-package golden-ratio)
(golden-ratio-mode 1)
\end{verbatim}
\section{check later}
\label{sec:org72e921b}
;; 1. \textbf{Update Compat and Marginalia}: Use the commands below to update both packages:
;;    emacs-lisp
   ;; (straight-pull-package 'compat)
   ;; (straight-pull-package 'marginalia)


;; 2. \textbf{Configure use-package}: Ensure you have the correct configuration in your init.el:
;;    emacs-lisp
(use-package compat)
\section{Enable rich annotations using the Marginalia package}
\label{sec:orgf4a6d5e}
\begin{verbatim}
...
\end{verbatim}
\section{For AUCTeX + SumatraPDF}
\label{sec:orged66193}
\begin{verbatim}
...
;;   (org-link-beautify-mode 1) ;                                                                (toggle org-link-beautify-mode)
...
\end{verbatim}
\section{listen$\backslash$}
\label{sec:orgb16e6ca}
\begin{verbatim}
(use-package listen
  :init
