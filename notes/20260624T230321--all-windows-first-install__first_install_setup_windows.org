...
#+begin_src powershell
  scoop install git curl  mpv dopamine grep findutils xargs freetube ytdlp-interface deno ffmpeg yt-dlp VictorMono-NF album-art-downloader powertoys nomacs googlechrome-canary oh-myposh glazewm zebar
#+end_src
...
(use-package consult
  :ensure t
  :bind (("C-s" . consult-line) 	; search withing current documents
         ("C-x b" . consult-buffer)	;seaarch across all open buffers
         ("C-c M-x" . consult-mode-command) ;
	 ("C-c o" . concult-outline)
