...
#+title:      emacs config chemac2
#+date:       [2026-07-07 Tue 23:09]
#+filetags:   :chemac2:config:emacs:org:
#+identifier: 20260707T230955

* lets try to see if its works.
** now package is all set in the init.el so no need to load them here again
skipped
#+begin_comment
;;; package --- Summary
;; USE-PACKAGE
...
* startbuffer and upcase downcase
#+begin_src emacs-lisp
